...
abstract contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function enterRaffle() public payable {
        ...
        // Emit an event when we update a dynamicarray or mapping
        // Named event with the reverse function name
     ...
     * 2. The lottery should have at least one player with some ETH.
     * 3. Our subscription is funded eith some LINK.
